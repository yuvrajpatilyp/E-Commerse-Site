...
const Card = ({ title, newprice, oldprice, image, discount, onAddToCart }) => {
    ...
    return (
        <div className="flex flex-col w-64 relative group">
            ...
            <div
                className="bg-gray-100 p-6 w-full h-60 shadow-md relative overflow-hidden 
            ...
            >
                ...
                <button
                    ...
                    className="absolute bottom-0 left-0 right-0 bg-black text-white py-2 text-sm font-semibold
